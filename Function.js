...
function PrintSt() {
	...
	"<button id=OO onclick=OO()><font color=Black><b>O</button> <button id=XX onclick=XX()><b>X</button>" +
	" <button id=HintA onclick=HintA()><b>HintA</button>";
...
function Winn() {
	...
	for (i=1; i<=Hg; i++) 
	 ...
	 End = 1;
	 document.getElementById("Msg").innerHTML = "<font size=5 color=Blue>You Win!!!";
}
